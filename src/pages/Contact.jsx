    ...
    <>
      ...
      */}
      ...
      <div className="relative w-full bg-black py-24 md:py-40 flex flex-col items-center justify-center overflow-hidden font-sans">
        {/* --- MARQUEE SECTION --- */}
        <a
          href="mailto:prabhudattarout35@gmail.com"
          className="w-[120%] ml-[-10%] bg-[#D3FD50] font-[font1] transform -rotate-4 flex overflow-hidden py-4 shadow-xl cursor-pointer hover:opacity-95 transition-opacity"
        >
          {/* First Moving Block */}
